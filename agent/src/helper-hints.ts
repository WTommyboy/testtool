...
const ALLOWED_OPERATION_TEMPLATES = new Set([
  ...
  "tagTool.selectManualTypeAndObserve",
  "tagTool.observeVariableSettings",
  "tagTool.uploadManualCsv",
  "tagTool.openDangerousModalAndCancel",
  "tagTool.createConditionTag",
  "tagTool.createManualTag",
  "tagTool.saveVariableSettings",
...
const ALLOWED_EVIDENCE = new Set([
  ...
  "tagVariables.history.state",
  "dangerousModal.state",
  "screenshot",
  "toolBridge.response",
  "xlsx.readback"
]);
