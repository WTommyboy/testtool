...
const roleForInputKey = (key: string): string => {
  ...
  const roles: Record<string, string> = {
    ...
    domain_action_tag_list: "domain action contract for TAG_TOOL player tag list observation",
    domain_action_create_condition_tag: "domain action contract for TAG_TOOL condition tag create form",
    domain_action_manual_upload: "domain action contract for TAG_TOOL manual tag CSV upload",
    domain_action_tag_variable_settings: "domain action contract for TAG_TOOL variable settings",
    domain_action_dangerous_actions: "domain action contract for TAG_TOOL approval-gated delete/terminate/save flows",
