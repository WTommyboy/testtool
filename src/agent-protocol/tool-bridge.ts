export type IrreversibleOperationRequest = {
...
export type AmbiguityDecisionRequest = {
...
export type PlaywrightRecoveryRequest = {
...
export type ToolRequest = IrreversibleOperationRequest | AmbiguityDecisionRequest | PlaywrightRecoveryRequest;
...
export const isToolRequest = (value: unknown): value is ToolRequest => {
  return validateToolRequest(value).valid;
};
