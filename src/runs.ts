...
const getDomainInputUrls = (req: Request, domain: string): Record<string, string> => {
  ...
  const optionalDomainInputs: Array<{ key: string; fileName: OptionalDomainPackFile; path: string }> = [
    ...
    { key: "domain_action_tag_list", fileName: "action-contracts/tagList.json", path: "action-contracts/tagList" },
    { key: "domain_action_create_condition_tag", fileName: "action-contracts/createConditionTag.json", path: "action-contracts/createConditionTag" },
    { key: "domain_action_manual_upload", fileName: "action-contracts/manualUpload.json", path: "action-contracts/manualUpload" },
    { key: "domain_action_tag_variable_settings", fileName: "action-contracts/tagVariableSettings.json", path: "action-contracts/tagVariableSettings" },
    { key: "domain_action_dangerous_actions", fileName: "action-contracts/dangerousActions.json", path: "action-contracts/dangerousActions" },
