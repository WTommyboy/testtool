...
- P0.16 wire planner, capability gate, helper execution plan, interaction log, and result gate through structured `action + target + role + expectedOutcome + evidenceRequirements`.
- P0.17 run offline route/judgment smoke against the oracle before any dev UAT request.
