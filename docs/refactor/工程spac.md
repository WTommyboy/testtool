...
- P0.19 repair remaining templates under the new vocabulary: dual preset selection, static-tab clickability, hover tooltip, project-limit disabled create state, report picker search/select, validation toast/no request, panel cancel/no change, and calculate/download/toast.
